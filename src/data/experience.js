export const webDevelopingExperience = [
  {
    companyName: "Dot.",
    position: "Frontend Developer",
    duration: "5/2023 - Present",
    description: [
      "Dot is a software house for a group of restaurants that builds related software applications.",
      "We build and maintain an ERP system to manage restaurant’s inventory ,cashier , warehouses , etc…",
    ],
    responsible: {
      info: "My responsibilities are: ",
      points: [
        "Building UI for different layouts.",
        "Integrating with backend APIs.",
        "Documenting and debugging the already working system.",
      ],
    },
...

  {
    ...
    responsible: {
      info: "My responsibilities are: ",
      points: [
        "Handling requests coming from the frontend team (as backend).",
        "Building well-organized and structured backend App (as backend).",
        "Documenting on SwaggerUI (as backend).",
        "Helping in building new layouts (as frontend).",
      ],
    },
    techStack: ["Typescript", "React", "Nodejs", "Expressjs", "MongoDB"],
  ...
  },
  {
    ...
    responsible: {
      info: "I worked with large team, been guided by a senior frontend developer. I was responsible for:",
      points: [
        "Creating new layouts and updating UI.",
        "Hundling Functionality of the pages.",
      ],
    },
    techStack: ["React", "JavaScript", "Styled Component", "Bootstrap"],
    website: "https://www.atomic.dev/",
  },
];
